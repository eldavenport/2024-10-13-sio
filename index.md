...
address: "(Room TBA)"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
longitude: "-117"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Oct 14, 16, 17, & 22  2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "3:00/3:30 pm - 6:00 pm PDT"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Ellen Davenport", "Luke Colosi"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Tommy Stone", "Ray Young, Sam Schulz"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["edavenport@uscd.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions
...
<p id="who-can-attend">
    ...
    This workshop is open to members of the SIO community, with priority given to students, in particular incoming students. The content is geared towards those who are completely new to the topics, but could still be useful to those with some relevant experience and will include tips that are specific to data analysis in the Earth Sciences. If you have questions about the content or format feel free to reach out at the email listed above. 
</p>
