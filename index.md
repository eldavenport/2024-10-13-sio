...
humandate: "Oct 13,14,17 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
email: ["first@example.org","second@example.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["edavenport@ucsd.edu"]
